...
@section('content')
    ...
    <x-card>
        ...
        <div class="d-flex justify-content-end">
            <button class="btn btn-sm btn-primary" onclick="location.href='{{ route('kasir.transaksi.create') }}'"><i
                    ...
                    @foreach ($transaksi as $transaksi)
                        <tr>
                            ...
                            @if ($transaksi->status != 'selesai')
                                <td>{{ $transaksi->status }}
                                    <form method="POST" style="display: inline"
                                        action="{{ route('kasir.transaksi.selesai', $transaksi->id) }}">
                                        @csrf
                            ...
                            @if ($transaksi->dibayar == 'belum_dibayar')
                                <td>
                                    <form method="POST" style="display: inline"
                                        action="{{ route('kasir.transaksi.paid', $transaksi->id) }}">
                                        @csrf
                            ...
                            <td><button class="btn btn-sm btn-outline-secondary"
                                    onclick="location.href='{{ route('kasir.transaksi.show', $transaksi->id) }}'"><i
                                        class="fas fa-eye"></i></button></td>
                            <td><button class="btn btn-sm btn-outline-primary"
                                    onclick="location.href='{{ route('kasir.transaksi.edit', $transaksi->id) }}'"><i
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="POST" style="display:inline;"
                                                    action="{{ route('kasir.transaksi.destroy', $transaksi->id) }}">
                                                    @csrf
                                                    @method('DELETE')
