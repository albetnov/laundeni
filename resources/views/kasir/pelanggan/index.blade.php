...
@section('content')
    ...
    <x-card>
        ...
        <div class="d-flex justify-content-end">
            <button class="btn btn-sm btn-primary" onclick="location.href='{{ route('kasir.pelanggan.create') }}'"><i
                    ...
                    @foreach ($member as $member)
                        <tr>
                            ...
                            <td><button class="btn btn-sm btn-outline-primary"
                                    onclick="location.href='{{ route('kasir.pelanggan.edit', $member->id) }}'"><i
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="POST" style="display:inline;"
                                                    action="{{ route('kasir.pelanggan.destroy', $member->id) }}">
                                                    @csrf
                                                    @method('DELETE')
